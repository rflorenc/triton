...
tt.func @foo(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: tensor<128x128x!tt.ptr<f32>, #blocked>, %arg4: tensor<128x128x!tt.ptr<f32>, #blocked>) -> tensor<128x128xf32, #blocked1> {
  ...
  %0:4 = scf.for %arg6 = %arg0 to %arg1 step %arg2 iter_args(%k = %c0, %arg7 = %cst, %arg8 = %arg3, %arg9 = %arg4) -> (i32, tensor<128x128xf32, #blocked1>, tensor<128x128x!tt.ptr<f32>, #blocked>, tensor<128x128x!tt.ptr<f32>, #blocked>)  : i32 {
    ...
    %7 = tt.dot %5, %6, %arg7 {inputPrecision = 0 : i32} : tensor<128x128xf32, #ttg.dot_op<{opIdx = 0, parent = #blocked1}>> * tensor<128x128xf32, #ttg.dot_op<{opIdx = 1, parent = #blocked1}>> -> tensor<128x128xf32, #blocked1>
    ...
    %k_cond_2 = arith.cmpi eq, %next_k, %arg1 : i32
    scf.if %k_cond_2 {
      %res = tt.load %arg9 : tensor<128x128x!tt.ptr<f32>, #blocked>
      %rhs = ttg.convert_layout %7 : tensor<128x128xf32, #blocked1> -> tensor<128x128xf32, #blocked>
      %sum = arith.addf %res, %rhs : tensor<128x128xf32, #blocked>
      tt.store %arg9, %sum : tensor<128x128x!tt.ptr<f32>, #blocked>
    }
