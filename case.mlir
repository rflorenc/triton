...
tt.func @foo(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: tensor<128x128x!tt.ptr<f32>, #blocked>, %arg4: tensor<128x128x!tt.ptr<f32>, #blocked>) -> tensor<128x128xf64, #blocked1> {
  %cst = arith.constant dense<0.000000e+00> : tensor<128x128xf64, #blocked1>
  %cst1 = arith.constant dense<0.0> : tensor<128x128xf32, #blocked>
  %cst_0 = arith.constant dense<1> : tensor<128x128xi32, #blocked>
  %c0 = arith.constant 0 : i32
  %c1 = arith.constant 1 : i32

  %0:4 = scf.for %arg6 = %arg0 to %arg1 step %arg2 iter_args(%k = %c0, %arg7 = %cst, %arg8 = %arg3, %arg9 = %arg4) -> (i32, tensor<128x128xf64, #blocked1>, tensor<128x128x!tt.ptr<f32>, #blocked>, tensor<128x128x!tt.ptr<f32>, #blocked>)  : i32 {
    ...
    %7 = tt.dot %5, %6, %arg7 {inputPrecision = 0 : i32} : tensor<128x128xf32, #ttg.dot_op<{opIdx = 0, parent = #blocked1}>> * tensor<128x128xf32, #ttg.dot_op<{opIdx = 1, parent = #blocked1}>> -> tensor<128x128xf64, #blocked1>
    ...
    scf.yield %next_k, %7, %8, %9 : i32, tensor<128x128xf64, #blocked1>, tensor<128x128x!tt.ptr<f32>, #blocked>, tensor<128x128x!tt.ptr<f32>, #blocked>
  }
  tt.return %0#1 : tensor<128x128xf64, #blocked1>
}
